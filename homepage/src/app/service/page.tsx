    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          name: "성능점검 대행",
          description:
            "34개 정보통신설비 성능점검 대행, 성능점검표 기록·보존(5년), 매년 1회 이상 실시. 22년 IT 인프라 운영 경험 기반 구조적 진단.",
        },
      },
      {
        "@type": "Offer",
...
const services = [
  {
    ...
    summary:
      "정보통신설비 성능점검은 34개 대상 설비의 운전·운용에 필요한 성능을 전문 장비로 측정하는 법정 점검입니다. 공사업자 또는 용역업자가 대행할 수 있습니다.",
    points: [
  ...
  },
  {
    ...
    color: "#7C3AED",
    summary:
      "공사업자에게 유지보수·관리를 위탁하면 관리자를 선임한 것으로 봅니다(선임 간주). 선임 면제가 아니라 위탁 계약에 의해 선임 의무가 충족되는 구조입니다.",
    points: [
      ...
      <section className="section-padding">
        <div className="container-main">
          <div className="answer-block" aria-label="summary">
            <p>
              정보통신설비 성능점검 대행은 34개 대상 설비의 성능을 매년 1회 이상 전문 업체가 대신 점검하는 서비스입니다.
